...
const products = [
  {
    title: "Cabos Navais",
    description: "Resistência máxima à corrosão em ambientes marítimos e offshore.",
    label: "Naval",
    icon: Anchor,
  ...
  {
    title: "Cabos Móveis",
    description: "Flexibilidade superior para aplicações com movimentação constante.",
    label: "Industrial",
    icon: Smartphone,
  ...
  },
  {
    ...
    description: "Precisão na transmissão de sinais para sistemas automatizados.",
    label: "Automação",
    icon: Gauge,
  ...
  },
  {
    ...
    description: "Blindagem contra interferências eletromagnéticas para medições precisas.",
    label: "Precisão",
    icon: Waves,
  ...
  },
  {
    ...
    description: "Distribuição segura de energia em diversos níveis de tensão.",
    label: "Energia",
    icon: Zap,
