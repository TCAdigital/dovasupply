...
const products = [
  {
    ...
    label: "Precisão",
    icon: Gauge,
    image: "https://conduscobre.com.br/wp-content/uploads/2024/09/cabo-instrumentacao-1024x585.jpg",
  },
  {
    ...
    label: "Automação",
    icon: ShieldCheck,
    image: "https://mdpolicabos.com/wp-content/uploads/2024/07/Cabo-blindado-4-vias-Incendio.jpg",
  },
  {
